...
Women and men correlations are pearson. Women overall show marginal positive association between T1 hipp GMV and MAZE moves (Pearson, p = 0.08)
...
All correlations are spearman. Overall, T1 GMV volume is marginally positively associated with SI (Pearson, p = 0.054). For women, T1 volume was significantly associated with DSP solution index.
...
- Sex hormones for women were log-transformed, and correlations among women were Spearman rank. All correlations with men were Pearson.

- HORMONES: For women, progesterone was positively associated with GMV for posts (Spearman, p < 0.01). There were no associations with hormones for men.

- BEHAVIOR: For women, DSP solution index was positively associated with T1 hipp volume for women (Spearman, p = 0.04). Overall, T1 hipp volume was marginally associated with DSP solution index for women and men (Spearman, p = 0.054).
