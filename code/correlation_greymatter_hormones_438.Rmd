...
Data did not include correction for TIV since left and right CSF, GMV, and WMV were not included yet in this round for analysis.
...
Subject 438: average volume of 648.8035
...
Subject 438: average volume of 242.462
...
p1 <- ggplot(data = df_clean_repo, aes(y = avg_ca23,
  ...
  stat_summary(fun.y=mean, geom="point",
               shape=20, size=3, color="black", fill="black") +
  labs(x = "Reproductive Status",
       y = "Averaged CA23 Subfield Volume",
       title = "Reproductive Status") + 
  theme(legend.position = "none") +
   #Add 438
...
Subject 438: average volume of 724.0295
...
Subject 438: average volume of 1117.86
...
p1 <- ggplot(data = df_clean_repo, aes(y = avg_erc,
  ...
  stat_summary(fun.y=mean, geom="point",
               shape=20, size=3, color="black", fill="black") +
  labs(x = "Reproductive Status",
       y = "Averaged ERC Subfield Volume",
       title = "Reproductive Status") + 
  theme(legend.position = "none") +
   #Add 438
...
Subject 438: average volume of 2061.765
...
p1 <- ggplot(data = df_clean_repo, aes(y = avg_phc,
  ...
  stat_summary(fun.y=mean, geom="point",
               shape=20, size=3, color="black", fill="black") +
  labs(x = "Reproductive Status",
       y = "Averaged PHC Subfield Volume",
       title = "Reproductive Status") + 
  theme(legend.position = "none") +
   #Add 438
...
Subject 438: average volume of 1871.035
...
Subject 438: average volume of 352.936
...
p1 <- ggplot(data = df_clean_repo, aes(y = avg_sub,
  ...
  stat_summary(fun.y=mean, geom="point",
               shape=20, size=3, color="black", fill="black") +
  labs(x = "Reproductive Status",
       y = "Averaged SUB Subfield Volume",
       title = "Reproductive Status") + 
  theme(legend.position = "none") +
   #Add 438
