...
*Modified on:* December 22nd, 2022
...
ggplot(data = aim1_men_loop, aes(x = testosterone_spatial_ng_dl,
  ...
  #Change labels
  labs(x = "\nTestosterone (ng/dL)",
       y = "Degrees Traveled (3.0m)",
       caption = "Smoothing applied using `method = lm` and `formula = y ~ splines::bs(x, 0.5)`") +
...
#save
#ggsave("study1_loop_t_spatial_gam.png")
```
