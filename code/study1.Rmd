...
t.test(aim1_men_dsp$dsp_si_true_pct,
       aim1_women_dsp$dsp_si_true_pct) #p=0.176
...
dsp_merge_m %>% 
  dplyr::summarize(n_place = mean(shortcuts_total/success),
                  n_response = mean(learned_total/success))
