...
shapiro.test(aim1_men$dsp_si_true_pct)
shapiro.test(aim1_men$dsp_success_pct)
shapiro.test(aim1_men$maze_accuracy_pct)
shapiro.test(aim1_men$maze_moves)
shapiro.test(aim1_men$loop_pe_avg_m)
shapiro.test(aim1_men$loop_de_avg_degree)
shapiro.test(aim1_men$testosterone_spatial_ng_dl)
```
...
shapiro.test(aim1_women$dsp_si_true_pct)
shapiro.test(aim1_women$dsp_success_pct)
shapiro.test(aim1_women$maze_accuracy_pct)
shapiro.test(aim1_women$maze_moves)
shapiro.test(aim1_women$loop_pe_avg_m)
shapiro.test(aim1_women$loop_de_avg_degree)
shapiro.test(aim1_women$estradiol_spatial_pg_ml)
shapiro.test(aim1_women$fsh_spatial_miu_ml)
```
...
cor.test(aim1_women$fsh_spatial_miu_ml,
         ...
         method = "spearman")
```
No correlation for wayfinding success, but significant correlation for solution index.
...
## Estradiol to FSH ratio in Midlife Women
...
#Plot ratio x success



#Plot ratio x soltuion index
...
Solution index is still significant
