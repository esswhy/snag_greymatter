...
aim1_men_dsp %>%  #group_by(repo_status) %>% 
  summarize(count = n(),
            ...
            min_age = min(age_spatial_years),
            max_age = max(age_spatial_years),
            mean_viq = mean(viq, na.rm = TRUE),
            sd_viq = sd(viq, na.rm = TRUE),
            min_viq = min(viq, na.rm = TRUE),
            max_viq = max(viq, na.rm = TRUE),
            mean_edu = mean(education_years, na.rm = TRUE),
            sd_edu = sd(education_years, na.rm = TRUE),
            min_edu = min(education_years, na.rm = TRUE),
            max_edu = max(education_years, na.rm = TRUE),
            total_white = sum(ethnicity == "White", na.rm=TRUE),
            perc_white = total_white/n(),
...
```{r dsp-men-partial}
########## pearson for wayfinding success
pcor_dsp_t <- aim1_men_dsp %>% 
  filter(is.na(testosterone_spatial_ng_dl) != TRUE)


pcor.test(pcor_dsp_t$testosterone_spatial_ng_dl,
          pcor_dsp_t$dsp_success_pct,
          pcor_dsp_t$age_spatial_years, 
          method = "pearson") #p-value=0.823401

#One-tailed
x <- pcor_dsp_t$testosterone_spatial_ng_dl
y <- pcor_dsp_t$dsp_success_pct
z <- pcor_dsp_t$age_spatial_years
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         alternative = "greater",
         conf.level = 0.95,
         method = "spearman") #p-value=0.7128
...
pcor.test(pcor_dsp_t$testosterone_spatial_ng_dl,
          pcor_dsp_t$dsp_si_true_pct,
          pcor_dsp_t$age_spatial_years, 
          method = "spearman") #p-value=0.4440199

#One-tailed
x <- pcor_dsp_t$testosterone_spatial_ng_dl
y <- pcor_dsp_t$dsp_si_true_pct
z <- pcor_dsp_t$age_spatial_years
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         alternative = "greater",
         conf.level = 0.95,
         method = "spearman") #p-value=0.8507
...
pcor_maze_t <- aim1_men_maze %>% 
  filter(is.na(testosterone_spatial_ng_dl) != TRUE)


pcor.test(pcor_maze_t$testosterone_spatial_ng_dl,
          pcor_maze_t$maze_accuracy_pct,
          pcor_maze_t$age_spatial_years, 
          method = "spearman") #p-value=0.5105994	

#One-tailed
x <- pcor_maze_t$testosterone_spatial_ng_dl
y <- pcor_maze_t$maze_accuracy_pct
z <- pcor_maze_t$age_spatial_years
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         alternative = "greater",
         conf.level = 0.95,
         method = "spearman") #p-value=0.5637
...
pcor.test(pcor_maze_t$testosterone_spatial_ng_dl,
          pcor_maze_t$maze_moves,
          pcor_maze_t$age_spatial_years, 
          method = "pearson") #p-value=0.8465817

#One-tailed
x <- pcor_maze_t$testosterone_spatial_ng_dl
y <- pcor_maze_t$maze_moves
z <- pcor_maze_t$age_spatial_years
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         alternative = "greater",
         conf.level = 0.95,
         method = "pearson") #p-value=0.5786
...
pcor_loop_t <- aim1_men_loop %>% 
  filter(is.na(testosterone_spatial_ng_dl) != TRUE)


pcor.test(pcor_loop_t$testosterone_spatial_ng_dl,
          pcor_loop_t$loop_pe_rad3_m,
          pcor_loop_t$age_spatial_years, 
          method = "pearson") #p-value=0.6612109	

#One-tailed
x <- pcor_loop_t$testosterone_spatial_ng_dl
y <- pcor_loop_t$loop_pe_rad3_m
z <- pcor_loop_t$age_spatial_years
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         alternative = "greater",
         conf.level = 0.95,
         method = "pearson") #p-value=0.6748
...
pcor.test(pcor_loop_t$testosterone_spatial_ng_dl,
          pcor_loop_t$loop_de_rad3_degree,
          pcor_loop_t$age_spatial_years, 
          method = "spearman") #p-value=0.05318446

#One-tailed
x <- pcor_loop_t$testosterone_spatial_ng_dl
y <- pcor_loop_t$loop_de_rad3_degree
z <- pcor_loop_t$age_spatial_years
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         alternative = "greater",
         conf.level = 0.95,
         method = "pearson") #p-value=0.992
...
#plot
a+b
ggsave("study1_hormone_age.jpg", dpi=1200)
```
...
### Testosterone
kruskal.test(testosterone_spatial_ng_dl ~ repo_status,
      data = aim1_women) #p = 0.0886
#Check pairwise comparisons using Wilcoxon rank sum test
```
...
pcor.test(aim1_women_dsp$estradiol_spatial_pg_ml,
          aim1_women_dsp$dsp_success_pct,
          aim1_women_dsp$age_spatial_years, 
          method = "spearman") #p-value=0.4694946

#One-tailed
x <- aim1_women_dsp$estradiol_spatial_pg_ml
y <- aim1_women_dsp$dsp_si_true_pct
z <- aim1_women_dsp$age_spatial_years
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         alternative = "greater",
         conf.level = 0.95,
         method = "spearman") #p-value=0.02852, rho=0.2795525 

x <- aim1_women_dsp$estradiol_spatial_pg_ml
y <- aim1_women_dsp$dsp_success_pct
z <- aim1_women_dsp$age_spatial_years
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         alternative = "greater",
         conf.level = 0.95,
         method = "spearman") #p-value=0.7301


#Remove two outliers for Estradiol: 355 and 415
aim1_women_outlier_e <- aim1_women_dsp %>% 
  filter(!subject_id %in% c(
    "415"))
  
#Regular non-partial corr
cor.test(aim1_women_outlier_e$estradiol_spatial_pg_ml,
         aim1_women_outlier_e$dsp_si_true_pct,
         alternative = "greater",
         conf.level = 0.95,
         method = "spearman") #p-value:0.003529

#Partial correlation
x <- aim1_women_outlier_e$estradiol_spatial_pg_ml
y <- aim1_women_outlier_e$dsp_si_true_pct
z <- aim1_women_outlier_e$age_spatial_years
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         alternative = "greater",
         conf.level = 0.95,
         method = "spearman") #p-value=0.04934
...
#One-tailed
x <- pcor_dsp_fsh$fsh_spatial_miu_ml
y <- pcor_dsp_fsh$dsp_si_true_pct
z <- pcor_dsp_fsh$age_spatial_years
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         alternative = "less",
         conf.level = 0.95,
         method = "spearman") #p-value=0.05638. rho = -0.2370101 

x <- pcor_dsp_fsh$fsh_spatial_miu_ml
y <- pcor_dsp_fsh$dsp_success_pct
z <- pcor_dsp_fsh$age_spatial_years
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         alternative = "less",
         conf.level = 0.95,
         method = "spearman") #p-value=0.05638

#E:FSH ratio
pcor_dsp_fsh <- pcor_dsp_fsh %>% 
  mutate(e_fsh_ratio = estradiol_spatial_pg_ml/fsh_spatial_miu_ml)

x <- pcor_dsp_fsh$e_fsh_ratio
y <- pcor_dsp_fsh$dsp_si_true_pct
z <- pcor_dsp_fsh$age_spatial_years
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         conf.level = 0.95,
         method = "spearman") #p-value=0.283



############# Progesterone
pcor_dsp_p <- aim1_women_dsp %>% 
  filter(is.na(progesterone_spatial_ng_ml) != TRUE)

pcor.test(pcor_dsp_p$progesterone_spatial_ng_ml,
          pcor_dsp_p$dsp_si_true_pct,
          pcor_dsp_p$age_spatial_years, 
          method = "spearman") #p-value=0.8096318

pcor.test(pcor_dsp_p$progesterone_spatial_ng_ml,
          pcor_dsp_p$dsp_success_pct,
          pcor_dsp_p$age_spatial_years, 
          method = "spearman") #p-value=0.600354

#E:P ratio?
pcor_dsp_p <- pcor_dsp_p %>% 
  mutate(e_p_ratio = estradiol_spatial_pg_ml/progesterone_spatial_ng_ml)

pcor.test(pcor_dsp_p$e_p_ratio,
          pcor_dsp_p$dsp_si_true_pct,
          pcor_dsp_p$age_spatial_years, 
          method = "spearman") #p-value = 0.1140327



############# Testosterone
pcor_dsp_t <- aim1_women_dsp %>% 
  filter(is.na(testosterone_spatial_ng_dl) != TRUE)

pcor.test(pcor_dsp_t$testosterone_spatial_ng_dl,
          pcor_dsp_t$dsp_si_true_pct,
          pcor_dsp_t$age_spatial_years, 
          method = "spearman") #p-value=0.3994875
...
```{r maze-women-partial}
##### ALL spearman

#### Estradiol
x <- aim1_women_maze$estradiol_spatial_pg_ml
y <- aim1_women_maze$maze_accuracy_pct
z <- aim1_women_maze$age_spatial_years
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         alternative = "greater",
         conf.level = 0.95,
         method = "spearman") #p=0.4192

x <- aim1_women_maze$estradiol_spatial_pg_ml
y <- aim1_women_maze$maze_moves
z <- aim1_women_maze$age_spatial_years
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         alternative = "greater",
         conf.level = 0.95,
         method = "spearman") #p=0.5849


#### FSH
pcor_maze_fsh <- aim1_women_maze %>% 
  filter(is.na(fsh_spatial_miu_ml) != TRUE)

#One-tailed
x <- pcor_maze_fsh$fsh_spatial_miu_ml
y <- pcor_maze_fsh$maze_accuracy_pct
z <- pcor_maze_fsh$age_spatial_years
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         alternative = "less",
         conf.level = 0.95,
         method = "spearman") #p-value=0.4085

#One-tailed
x <- pcor_maze_fsh$fsh_spatial_miu_ml
y <- pcor_maze_fsh$maze_moves
z <- pcor_maze_fsh$age_spatial_years
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         alternative = "less",
         conf.level = 0.95,
         method = "spearman") #p-value=0.6586

#### Progesterone
pcor_maze_p <- aim1_women_maze %>% 
  filter(is.na(progesterone_spatial_ng_ml) != TRUE)

x <- pcor_maze_p$progesterone_spatial_ng_ml
y <- pcor_maze_p$maze_accuracy_pct
z <- pcor_maze_p$age_spatial_years
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         conf.level = 0.95,
         method = "spearman") #p-value=0.9287

x <- pcor_maze_p$progesterone_spatial_ng_ml
y <- pcor_maze_p$maze_moves
z <- pcor_maze_p$age_spatial_years
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         conf.level = 0.95,
         method = "spearman") #p-value=0.4291


#### Testosterone
pcor_maze_t <- aim1_women_maze %>% 
  filter(is.na(testosterone_spatial_ng_dl) != TRUE)
...
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         conf.level = 0.95,
         method = "spearman") #p-value=0.06934, rho=-0.2341405 
...
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         conf.level = 0.95,
         method = "spearman") #p-value=0.4821
```
...
```{r loop-women-partial}
######### Estradiol
#One-tailed
x <- aim1_women_loop$estradiol_spatial_pg_ml
y <- aim1_women_loop$loop_pe_rad3_m
z <- aim1_women_loop$age_spatial_years
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         alternative = "greater",
         conf.level = 0.95,
         method = "spearman") #p-value=0.547

x <- aim1_women_loop$estradiol_spatial_pg_ml
y <- aim1_women_loop$loop_de_rad3_degree
z <- aim1_women_loop$age_spatial_years
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         alternative = "greater",
         conf.level = 0.95,
         method = "spearman") #p-value=0.463

######### FSH
pcor_loop_fsh <- aim1_women_loop %>% 
  filter(is.na(fsh_spatial_miu_ml) != TRUE)

x <- pcor_loop_fsh$fsh_spatial_miu_ml
y <- pcor_loop_fsh$loop_pe_rad3_m
z <- pcor_loop_fsh$age_spatial_years
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         alternative = "less",
         conf.level = 0.95,
         method = "spearman") #p-value=0.3061

x <- pcor_loop_fsh$fsh_spatial_miu_ml
y <- pcor_loop_fsh$loop_de_rad3_degree
z <- pcor_loop_fsh$age_spatial_years
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         alternative = "less",
         conf.level = 0.95,
         method = "spearman") #p-value=0.6728


######### Progesterone
pcor_loop_p <- aim1_women_loop %>% 
  filter(is.na(progesterone_spatial_ng_ml) != TRUE)

x <- pcor_loop_p$progesterone_spatial_ng_ml
y <- pcor_loop_p$loop_pe_rad3_m
z <- pcor_loop_p$age_spatial_years
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         conf.level = 0.95,
         method = "spearman") #p-value=0.9796

x <- pcor_loop_p$progesterone_spatial_ng_ml
y <- pcor_loop_p$loop_de_rad3_degree
z <- pcor_loop_p$age_spatial_years
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         conf.level = 0.95,
         method = "spearman") #p-value=0.06177, rho=0.378919 

######### Testosterone
pcor_loop_t <- aim1_women_loop %>% 
  filter(is.na(testosterone_spatial_ng_dl) != TRUE)
...
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         conf.level = 0.95,
         method = "spearman") #p-value=0.6818
...
cor.test(lm(x ~ z)$residuals,
         lm(y ~ z)$residuals,
         conf.level = 0.95,
         method = "spearman") #p-value=0.02669, rho=0.4285714
```
...
```{r loop-women-degrees-testosterone-plot}
#Testosterone and degrees traveled for women
#Controlling for age

ggplot(data = aim1_women_loop, aes(x = testosterone_spatial_ng_dl,
                                   y = loop_de_rad3_degree)) +
  ...
  labs(x = "Testosterone (ng/dL)",
       y = "Degrees Traveled at 3.0 m\n",
       color = "Reproductive Status") +
  
  #Change color of points
  scale_color_manual(values = c("cadetblue4", "mediumvioletred", "darkorange")) +
  
  #Add dashed line at 360 degrees
  geom_line(y = 360, color = "grey", size = 1.3,
            linetype = "dashed") +
...
#Save figure
#ggsave("testosterone_degrees_women.jpg", dpi=1200)
```

```{r}
#Check number of women in testosterone and loop corr
aim1_women_loop %>% #group_by(repo_status) %>% 
  filter(is.na(progesterone_spatial_ng_ml) != TRUE) %>% 
  summarize(count = n())
```
...
median(aim1_men_maze$maze_accuracy_pct, na.rm=TRUE) #0.125
median(aim1_women_maze$maze_accuracy_pct, na.rm=TRUE) #0.125
