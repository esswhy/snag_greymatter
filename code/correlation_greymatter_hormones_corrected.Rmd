...
*Hippocampal Grey Matter Volume:*

1) Filter participants that have GMV from ASHS
...
1) After left and right T2 subfields were corrected for TIV, sum up left and right total hipp 
...
df_avg <- df %>% 
  ...
  mutate(total_l_hipp = (lca1 + lca23 + ldg + lerc + lphc + lprc + lsub),
         total_r_hipp = (rca1 + rca23 + rdg + rerc + rphc + rprc + rsub),
...
Shapiro-Wilk's test reveal that CA23 for men, and SUB overall and SUB for women were not normally distributed. Also, total hipp for overall and for women were not normally distributed. Hormone and subfield associations for these subfields will be using Spearman rank correlation.
...
Slight right skew in total hipp volume
