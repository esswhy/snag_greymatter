...
```{r include=TRUE, echo=FALSE}
#All
c1 <- ggscatter(data_loop, x = "avg_ca1", y = "loop_pe_avg_m", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#By sex
c1a <- ggscatter(data_loop_women, x = "avg_ca1", y = "loop_pe_avg_m", color = "red", alpha = 0.6, title = "Women",
          add = "reg.line", 
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
     ...
     theme_bw() +
     theme(legend.position = "none")
c1b <- ggscatter(data_loop_men, x = "avg_ca1", y = "loop_pe_avg_m", color = "#00AFBB", alpha = 0.6, title = "Men",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#By repo
c1c <- ggscatter(data_loop_women, x = "avg_ca1", y = "loop_pe_avg_m", color = "repo_status", 
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
