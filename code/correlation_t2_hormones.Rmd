...
h4 <- ggplot(data = data, aes(x = dhea_s_ug_d_l)) +
  geom_histogram(alpha = 0.5, color = "black", position = "identity") +
  labs(x = "DHEAS (ug/dL)",
       y = "Count",
       title = "Raw")
h4a <- ggplot(data = data, aes(x = log(dhea_s_ug_d_l))) +
  geom_histogram(alpha = 0.5, color = "black", position = "identity") +
  labs(x = "Log DHEAS (ug/dL)",
       y = "Count",
       title = "Log Transformed")
h5 <- ggplot(data = data, aes(x = shbg_nmol_l)) +
  geom_histogram(alpha = 0.5, color = "black", position = "identity") +
  labs(x = "SHBG (nmol/L)",
       y = "Count",
       title = "Raw")
h5a <- ggplot(data = data, aes(x = log(shbg_nmol_l))) +
  geom_histogram(alpha = 0.5, color = "black", position = "identity") +
  labs(x = "Log SHBG (nmol/L)",
       y = "Count",
       title = "Log Transformed")
h6 <- ggplot(data = data, aes(x = total_testosterone_ng_d_l)) +
  geom_histogram(alpha = 0.5, color = "black", position = "identity") +
  labs(x = "Testosterone (ng/dL)",
       y = "Count",
       title = "Raw")
h6a <- ggplot(data = data, aes(x = log(total_testosterone_ng_d_l))) +
  geom_histogram(alpha = 0.5, color = "black", position = "identity") +
  labs(x = "Log Testosterone (ng/dL)",
       y = "Count",
       title = "Log Transformed")
...
h4 <- ggplot(data = data_men, aes(x = dhea_s_ug_d_l)) +
  geom_histogram(alpha = 0.5, color = "black", position = "identity") +
  labs(x = "DHEAS (ug/dL)",
       y = "Count",
       title = "Raw")
h4a <- ggplot(data = data_men, aes(x = log(dhea_s_ug_d_l))) +
  geom_histogram(alpha = 0.5, color = "black", position = "identity") +
  labs(x = "Log DHEAS (ug/dL)",
       y = "Count",
       title = "Log Transformed")
h5 <- ggplot(data = data_men, aes(x = shbg_nmol_l)) +
  geom_histogram(alpha = 0.5, color = "black", position = "identity") +
  labs(x = "SHBG (nmol/L)",
       y = "Count",
       title = "Raw")
h5a <- ggplot(data = data_men, aes(x = log(shbg_nmol_l))) +
  geom_histogram(alpha = 0.5, color = "black", position = "identity") +
  labs(x = "Log SHBG (nmol/L)",
       y = "Count",
       title = "Log Transformed")
h6 <- ggplot(data = data_men, aes(x = total_testosterone_ng_d_l)) +
  geom_histogram(alpha = 0.5, color = "black", position = "identity") +
  labs(x = "Testosterone (ng/dL)",
       y = "Count",
       title = "Raw")
h6a <- ggplot(data = data_men, aes(x = log(total_testosterone_ng_d_l))) +
  geom_histogram(alpha = 0.5, color = "black", position = "identity") +
  labs(x = "Log Testosterone (ng/dL)",
       y = "Count",
       title = "Log Transformed")
...
```{r}
#Estradiol
c1 <- ggscatter(data_repo, x = "estradiol_pg_m_l", y = "avg_total_hipp", color = "repo_status",
          add = "reg.line",
...
#Estradiol facet
c1a <- ggscatter(data_repo, x = "estradiol_pg_m_l", y = "avg_total_hipp", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Progesterone
c2 <- ggscatter(data_repo, x = "progesterone_ng_m_l", y = "avg_total_hipp", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Progesterone facet
c2a <- ggscatter(data_repo, x = "progesterone_ng_m_l", y = "avg_total_hipp", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#FSH
c3 <- ggscatter(data_repo, x = "fsh_m_iu_m_l", y = "avg_total_hipp", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#FSH facet
c3a <- ggscatter(data_repo, x = "fsh_m_iu_m_l", y = "avg_total_hipp", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#SHBG
c4 <- ggscatter(data_repo, x = "shbg_nmol_l", y = "avg_total_hipp", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#SHBG facet
c4a <- ggscatter(data_repo, x = "shbg_nmol_l", y = "avg_total_hipp", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS
c5 <- ggscatter(data_repo, x = "dhea_s_ug_d_l", y = "avg_total_hipp", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS facet
c5a <- ggscatter(data_repo, x = "dhea_s_ug_d_l", y = "avg_total_hipp", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone
c6 <- ggscatter(data_repo, x = "total_testosterone_ng_d_l", y = "avg_total_hipp", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone facet
c6a <- ggscatter(data_repo, x = "total_testosterone_ng_d_l", y = "avg_total_hipp", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
```{r}
#SHBG
c1 <- ggscatter(data_men, x = "shbg_nmol_l", y = "avg_total_hipp",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS
c2 <- ggscatter(data_men, x = "dhea_s_ug_d_l", y = "avg_total_hipp",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone
c3 <- ggscatter(data_men, x = "total_testosterone_ng_d_l", y = "avg_total_hipp", 
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
```{r}
#Estradiol
c1 <- ggscatter(data_repo, x = "estradiol_pg_m_l", y = "avg_mtl", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Estradiol facet
c1a <- ggscatter(data_repo, x = "estradiol_pg_m_l", y = "avg_mtl", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Progesterone
c2 <- ggscatter(data_repo, x = "progesterone_ng_m_l", y = "avg_mtl", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Progesterone facet
c2a <- ggscatter(data_repo, x = "progesterone_ng_m_l", y = "avg_mtl", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#FSH
c3 <- ggscatter(data_repo, x = "fsh_m_iu_m_l", y = "avg_mtl", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#FSH facet
c3a <- ggscatter(data_repo, x = "fsh_m_iu_m_l", y = "avg_mtl", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#SHBG
c4 <- ggscatter(data_repo, x = "shbg_nmol_l", y = "avg_mtl", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#SHBG facet
c4a <- ggscatter(data_repo, x = "shbg_nmol_l", y = "avg_mtl", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS
c5 <- ggscatter(data_repo, x = "dhea_s_ug_d_l", y = "avg_mtl", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS facet
c5a <- ggscatter(data_repo, x = "dhea_s_ug_d_l", y = "avg_mtl", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone
c6 <- ggscatter(data_repo, x = "total_testosterone_ng_d_l", y = "avg_mtl", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone facet
c6a <- ggscatter(data_repo, x = "total_testosterone_ng_d_l", y = "avg_mtl", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
```{r}
#SHBG
c1 <- ggscatter(data_men, x = "shbg_nmol_l", y = "avg_mtl",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS
c2 <- ggscatter(data_men, x = "dhea_s_ug_d_l", y = "avg_mtl",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone
c3 <- ggscatter(data_men, x = "total_testosterone_ng_d_l", y = "avg_mtl", 
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
```{r}
#Estradiol
c1 <- ggscatter(data_repo, x = "estradiol_pg_m_l", y = "avg_ca1", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Estradiol facet
c1a <- ggscatter(data_repo, x = "estradiol_pg_m_l", y = "avg_ca1", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Progesterone
c2 <- ggscatter(data_repo, x = "progesterone_ng_m_l", y = "avg_ca1", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Progesterone facet
c2a <- ggscatter(data_repo, x = "progesterone_ng_m_l", y = "avg_ca1", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#FSH
c3 <- ggscatter(data_repo, x = "fsh_m_iu_m_l", y = "avg_ca1", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#FSH facet
c3a <- ggscatter(data_repo, x = "fsh_m_iu_m_l", y = "avg_ca1", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#SHBG
c4 <- ggscatter(data_repo, x = "shbg_nmol_l", y = "avg_ca1", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#SHBG facet
c4a <- ggscatter(data_repo, x = "shbg_nmol_l", y = "avg_ca1", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS
c5 <- ggscatter(data_repo, x = "dhea_s_ug_d_l", y = "avg_ca1", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS facet
c5a <- ggscatter(data_repo, x = "dhea_s_ug_d_l", y = "avg_ca1", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone
c6 <- ggscatter(data_repo, x = "total_testosterone_ng_d_l", y = "avg_ca1", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone facet
c6a <- ggscatter(data_repo, x = "total_testosterone_ng_d_l", y = "avg_ca1", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
```{r}
#SHBG
c1 <- ggscatter(data_men, x = "shbg_nmol_l", y = "avg_ca1",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS
c2 <- ggscatter(data_men, x = "dhea_s_ug_d_l", y = "avg_ca1",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone
c3 <- ggscatter(data_men, x = "total_testosterone_ng_d_l", y = "avg_ca1", 
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
```{r}
#Estradiol
c1 <- ggscatter(data_repo, x = "estradiol_pg_m_l", y = "avg_ca23", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Estradiol facet
c1a <- ggscatter(data_repo, x = "estradiol_pg_m_l", y = "avg_ca23", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Progesterone
c2 <- ggscatter(data_repo, x = "progesterone_ng_m_l", y = "avg_ca23", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Progesterone facet
c2a <- ggscatter(data_repo, x = "progesterone_ng_m_l", y = "avg_ca23", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#FSH
c3 <- ggscatter(data_repo, x = "fsh_m_iu_m_l", y = "avg_ca23", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#FSH facet
c3a <- ggscatter(data_repo, x = "fsh_m_iu_m_l", y = "avg_ca23", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#SHBG
c4 <- ggscatter(data_repo, x = "shbg_nmol_l", y = "avg_ca23", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#SHBG facet
c4a <- ggscatter(data_repo, x = "shbg_nmol_l", y = "avg_ca23", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS
c5 <- ggscatter(data_repo, x = "dhea_s_ug_d_l", y = "avg_ca23", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS facet
c5a <- ggscatter(data_repo, x = "dhea_s_ug_d_l", y = "avg_ca23", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone
c6 <- ggscatter(data_repo, x = "total_testosterone_ng_d_l", y = "avg_ca23", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone facet
c6a <- ggscatter(data_repo, x = "total_testosterone_ng_d_l", y = "avg_ca23", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
```{r}
#SHBG
c1 <- ggscatter(data_men, x = "shbg_nmol_l", y = "avg_ca23",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS
c2 <- ggscatter(data_men, x = "dhea_s_ug_d_l", y = "avg_ca23", 
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone
c3 <- ggscatter(data_men, x = "total_testosterone_ng_d_l", y = "avg_ca23",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
```{r}
#Estradiol
c1 <- ggscatter(data_repo, x = "estradiol_pg_m_l", y = "avg_dg", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Estradiol facet
c1a <- ggscatter(data_repo, x = "estradiol_pg_m_l", y = "avg_dg", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Progesterone
c2 <- ggscatter(data_repo, x = "progesterone_ng_m_l", y = "avg_dg", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Progesterone facet
c2a <- ggscatter(data_repo, x = "progesterone_ng_m_l", y = "avg_dg", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#FSH
c3 <- ggscatter(data_repo, x = "fsh_m_iu_m_l", y = "avg_dg", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#FSH facet
c3a <- ggscatter(data_repo, x = "fsh_m_iu_m_l", y = "avg_dg", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#SHBG
c4 <- ggscatter(data_repo, x = "shbg_nmol_l", y = "avg_dg", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#SHBG facet
c4a <- ggscatter(data_repo, x = "shbg_nmol_l", y = "avg_dg", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS
c5 <- ggscatter(data_repo, x = "dhea_s_ug_d_l", y = "avg_dg", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS facet
c5a <- ggscatter(data_repo, x = "dhea_s_ug_d_l", y = "avg_dg", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone
c6 <- ggscatter(data_repo, x = "total_testosterone_ng_d_l", y = "avg_dg", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone facet
c6a <- ggscatter(data_repo, x = "total_testosterone_ng_d_l", y = "avg_dg", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
```{r}
#SHBG
c1 <- ggscatter(data_men, x = "shbg_nmol_l", y = "avg_dg",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS
c2 <- ggscatter(data_men, x = "dhea_s_ug_d_l", y = "avg_dg",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone
c3 <- ggscatter(data_men, x = "total_testosterone_ng_d_l", y = "avg_dg",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
```{r}
#Estradiol
c1 <- ggscatter(data_repo, x = "estradiol_pg_m_l", y = "avg_erc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Estradiol facet
c1a <- ggscatter(data_repo, x = "estradiol_pg_m_l", y = "avg_erc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Progesterone
c2 <- ggscatter(data_repo, x = "progesterone_ng_m_l", y = "avg_erc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Progesterone facet
c2a <- ggscatter(data_repo, x = "progesterone_ng_m_l", y = "avg_erc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#FSH
c3 <- ggscatter(data_repo, x = "fsh_m_iu_m_l", y = "avg_erc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#FSH facet
c3a <- ggscatter(data_repo, x = "fsh_m_iu_m_l", y = "avg_erc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#SHBG
c4 <- ggscatter(data_repo, x = "shbg_nmol_l", y = "avg_erc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#SHBG facet
c4a <- ggscatter(data_repo, x = "shbg_nmol_l", y = "avg_erc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS
c5 <- ggscatter(data_repo, x = "dhea_s_ug_d_l", y = "avg_erc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS facet
c5a <- ggscatter(data_repo, x = "dhea_s_ug_d_l", y = "avg_erc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone
c6 <- ggscatter(data_repo, x = "total_testosterone_ng_d_l", y = "avg_erc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone facet
c6a <- ggscatter(data_repo, x = "total_testosterone_ng_d_l", y = "avg_erc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
```{r}
#SHBG
c1 <- ggscatter(data_men, x = "shbg_nmol_l", y = "avg_erc",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS
c2 <- ggscatter(data_men, x = "dhea_s_ug_d_l", y = "avg_erc", 
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone
c3 <- ggscatter(data_men, x = "total_testosterone_ng_d_l", y = "avg_erc",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
```{r}
#Estradiol
c1 <- ggscatter(data_repo, x = "estradiol_pg_m_l", y = "avg_phc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Estradiol facet
c1a <- ggscatter(data_repo, x = "estradiol_pg_m_l", y = "avg_phc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Progesterone
c2 <- ggscatter(data_repo, x = "progesterone_ng_m_l", y = "avg_phc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Progesterone facet
c2a <- ggscatter(data_repo, x = "progesterone_ng_m_l", y = "avg_phc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#FSH
c3 <- ggscatter(data_repo, x = "fsh_m_iu_m_l", y = "avg_phc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#FSH facet
c3a <- ggscatter(data_repo, x = "fsh_m_iu_m_l", y = "avg_phc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#SHBG
c4 <- ggscatter(data_repo, x = "shbg_nmol_l", y = "avg_phc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#SHBG facet
c4a <- ggscatter(data_repo, x = "shbg_nmol_l", y = "avg_phc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS
c5 <- ggscatter(data_repo, x = "dhea_s_ug_d_l", y = "avg_phc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS facet
c5a <- ggscatter(data_repo, x = "dhea_s_ug_d_l", y = "avg_phc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone
c6 <- ggscatter(data_repo, x = "total_testosterone_ng_d_l", y = "avg_phc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone facet
c6a <- ggscatter(data_repo, x = "total_testosterone_ng_d_l", y = "avg_phc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
```{r}
#SHBG
c1 <- ggscatter(data_men, x = "shbg_nmol_l", y = "avg_phc", 
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS
c2 <- ggscatter(data_men, x = "dhea_s_ug_d_l", y = "avg_phc", 
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone
c3 <- ggscatter(data_men, x = "total_testosterone_ng_d_l", y = "avg_phc", 
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
```{r}
#Estradiol
c1 <- ggscatter(data_repo, x = "estradiol_pg_m_l", y = "avg_prc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Estradiol facet
c1a <- ggscatter(data_repo, x = "estradiol_pg_m_l", y = "avg_prc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Progesterone
c2 <- ggscatter(data_repo, x = "progesterone_ng_m_l", y = "avg_prc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Progesterone facet
c2a <- ggscatter(data_repo, x = "progesterone_ng_m_l", y = "avg_prc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#FSH
c3 <- ggscatter(data_repo, x = "fsh_m_iu_m_l", y = "avg_prc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#FSH facet
c3a <- ggscatter(data_repo, x = "fsh_m_iu_m_l", y = "avg_prc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#SHBG
c4 <- ggscatter(data_repo, x = "shbg_nmol_l", y = "avg_prc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#SHBG facet
c4a <- ggscatter(data_repo, x = "shbg_nmol_l", y = "avg_prc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS
c5 <- ggscatter(data_repo, x = "dhea_s_ug_d_l", y = "avg_prc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS facet
c5a <- ggscatter(data_repo, x = "dhea_s_ug_d_l", y = "avg_prc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone
c6 <- ggscatter(data_repo, x = "total_testosterone_ng_d_l", y = "avg_prc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone facet
c6a <- ggscatter(data_repo, x = "total_testosterone_ng_d_l", y = "avg_prc", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
```{r}
#SHBG
c1 <- ggscatter(data_men, x = "shbg_nmol_l", y = "avg_prc", 
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS
c2 <- ggscatter(data_men, x = "dhea_s_ug_d_l", y = "avg_prc", 
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone
c3 <- ggscatter(data_men, x = "total_testosterone_ng_d_l", y = "avg_prc",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
```{r}
#Estradiol
c1 <- ggscatter(data_repo, x = "estradiol_pg_m_l", y = "avg_sub", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Estradiol facet
c1a <- ggscatter(data_repo, x = "estradiol_pg_m_l", y = "avg_sub", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Progesterone
c2 <- ggscatter(data_repo, x = "progesterone_ng_m_l", y = "avg_sub", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Progesterone facet
c2a <- ggscatter(data_repo, x = "progesterone_ng_m_l", y = "avg_sub", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#FSH
c3 <- ggscatter(data_repo, x = "fsh_m_iu_m_l", y = "avg_sub", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#FSH facet
c3a <- ggscatter(data_repo, x = "fsh_m_iu_m_l", y = "avg_sub", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#SHBG
c4 <- ggscatter(data_repo, x = "shbg_nmol_l", y = "avg_sub", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#SHBG facet
c4a <- ggscatter(data_repo, x = "shbg_nmol_l", y = "avg_sub", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS
c5 <- ggscatter(data_repo, x = "dhea_s_ug_d_l", y = "avg_sub", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS facet
c5a <- ggscatter(data_repo, x = "dhea_s_ug_d_l", y = "avg_sub", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone
c6 <- ggscatter(data_repo, x = "total_testosterone_ng_d_l", y = "avg_sub", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone facet
c6a <- ggscatter(data_repo, x = "total_testosterone_ng_d_l", y = "avg_sub", color = "repo_status",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
```{r}
#SHBG
c1 <- ggscatter(data_men, x = "shbg_nmol_l", y = "avg_sub",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#DHEAS
c2 <- ggscatter(data_men, x = "dhea_s_ug_d_l", y = "avg_sub", 
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
#Testosterone
c3 <- ggscatter(data_men, x = "total_testosterone_ng_d_l", y = "avg_sub",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
data_repo_post <- data_repo %>% 
  filter(repo_status == "Post")

###CA1
#Estradiol
c1a <- ggscatter(data_repo_post, x = "estradiol_pg_m_l", y = "avg_ca1", color = "#00AFBB",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
    ...
    theme(legend.position = "none")
#Progesterone
c1b <- ggscatter(data_repo_post, x = "progesterone_ng_m_l", y = "avg_ca1", color = "#00AFBB",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
    ...
    theme(legend.position = "none")
#FSH
c1c <- ggscatter(data_repo_post, x = "fsh_m_iu_m_l", y = "avg_ca1", color = "#00AFBB",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
###CA23
#Estradiol
c2a <- ggscatter(data_repo_post, x = "estradiol_pg_m_l", y = "avg_ca23", color = "#00AFBB",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
    ...
    theme(legend.position = "none")
#Progesterone
c2b <- ggscatter(data_repo_post, x = "progesterone_ng_m_l", y = "avg_ca23", color = "#00AFBB",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
    ...
    theme(legend.position = "none")
#FSH
c2c <- ggscatter(data_repo_post, x = "fsh_m_iu_m_l", y = "avg_ca23", color = "#00AFBB",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
###DG
#Estradiol
c3a <- ggscatter(data_repo_post, x = "estradiol_pg_m_l", y = "avg_dg", color = "#00AFBB",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
    ...
    theme(legend.position = "none")
#Progesterone
c3b <- ggscatter(data_repo_post, x = "progesterone_ng_m_l", y = "avg_dg", color = "#00AFBB",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
    ...
    theme(legend.position = "none")
#FSH
c3c <- ggscatter(data_repo_post, x = "fsh_m_iu_m_l", y = "avg_dg", color = "#00AFBB",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
###ERC
#Estradiol
c4a <- ggscatter(data_repo_post, x = "estradiol_pg_m_l", y = "avg_erc", color = "#00AFBB",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
    ...
    theme(legend.position = "none")
#Progesterone
c4b <- ggscatter(data_repo_post, x = "progesterone_ng_m_l", y = "avg_erc", color = "#00AFBB",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
    ...
    theme(legend.position = "none")
#FSH
c4c <- ggscatter(data_repo_post, x = "fsh_m_iu_m_l", y = "avg_erc", color = "#00AFBB",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
###PHC
#Estradiol
c5a <- ggscatter(data_repo_post, x = "estradiol_pg_m_l", y = "avg_phc", color = "#00AFBB",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
    ...
    theme(legend.position = "none")
#Progesterone
c5b <- ggscatter(data_repo_post, x = "progesterone_ng_m_l", y = "avg_phc", color = "#00AFBB",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
    ...
    theme(legend.position = "none")
#FSH
c5c <- ggscatter(data_repo_post, x = "fsh_m_iu_m_l", y = "avg_phc", color = "#00AFBB",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
###PRC
#Estradiol
c6a <- ggscatter(data_repo_post, x = "estradiol_pg_m_l", y = "avg_prc", color = "#00AFBB",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
    ...
    theme(legend.position = "none")
#Progesterone
c6b <- ggscatter(data_repo_post, x = "progesterone_ng_m_l", y = "avg_prc", color = "#00AFBB",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
    ...
    theme(legend.position = "none")
#FSH
c6c <- ggscatter(data_repo_post, x = "fsh_m_iu_m_l", y = "avg_prc", color = "#00AFBB",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
...
###SUB
#Estradiol
c7a <- ggscatter(data_repo_post, x = "estradiol_pg_m_l", y = "avg_sub", color = "#00AFBB",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
    ...
    theme(legend.position = "none")
#Progesterone
c7b <- ggscatter(data_repo_post, x = "progesterone_ng_m_l", y = "avg_sub", color = "#00AFBB",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
    ...
    theme(legend.position = "none")
#FSH
c7c <- ggscatter(data_repo_post, x = "fsh_m_iu_m_l", y = "avg_sub", color = "#00AFBB",
          add = "reg.line",
          add.params = list(color = "black", fill = "lightgray"), # Customize reg. line
          cor.coef = TRUE, # Add correlation coefficient. see ?stat_cor
          conf.int = TRUE, 
