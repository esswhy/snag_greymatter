...
ttest
```
T-test results comparing GMV by sex was significant. Women (*M* = 1.82) have larger T2 hippocampal volume than men (*M* = 1.71) (*t* = 2.81, *df* = 48.55, *p* < 0.01).
...
T-test results comparing MTL by sex was significant. Women (*M* = 5.64) have larger MTL volume than men (*M* = 5.32) (*t* = 2.39, *df* = 43.17, *p* < 0.05).
...
T-test results comparing CA1 by sex was significant. Women (*M* = 0.588) have larger CA1 volume than men (*M* = 0.543) (*t* = 2.95, *df* = 46.67, *p* < 0.01).
