...
#Combine
a + b
#ggsave("hormone_correlations.png")
```
...
```{r}
mod1 <- lm(dsp_si_true_pct ~ estradiol_spatial_pg_ml,
           data = df_women_dsp)
summary(mod1)



mod2 <- lm(dsp_si_true_pct ~ fsh_spatial_miu_ml,
           data = df_women_dsp)
summary(mod2)
```
...
Copy and paste script from Yu et al., 2021 code.
