...
df_women_dsp <- df_women %>% 
  ...
  mutate(e_group = case_when(estradiol_spatial_pg_ml < quantile(estradiol_spatial_pg_ml,0.5) ~ "low",
        ...
        #E 33/33/33
        e33_group = case_when(estradiol_spatial_pg_ml < quantile(estradiol_spatial_pg_ml,0.33) ~ "low",
                              between(estradiol_spatial_pg_ml, 
                                     quantile(estradiol_spatial_pg_ml, 0.33, na.rm=TRUE),
                                     quantile(estradiol_spatial_pg_ml, 0.66, na.rm=TRUE))~"medium", 
                      TRUE ~ 'high'))
...
ggsave("hormone_correlations_legendtop.png")
```
...
#ggsave("heatmap_pre.png")


#Peri
ggplot(hm_peri, aes(x=x, y=z) ) +
  stat_density_2d(aes(fill = ..density..), geom = "raster", contour = FALSE) +
  #scale_fill_distiller(palette= "RdYlGn", direction=-1) +
  scale_fill_distiller(palette= "RdYlGn", direction=-1) +
  scale_x_continuous(expand = c(0, 0)) +
...
#ggsave("heatmap_peri.png")

#Post
ggplot(hm_post, aes(x=x, y=z) ) +
  stat_density_2d(aes(fill = ..density..), geom = "raster", contour = FALSE) +
  #scale_fill_distiller(palette= "RdYlGn", direction=-1) +
  scale_fill_distiller(palette= "RdYlGn", direction=-1) +
  scale_x_continuous(expand = c(0, 0)) +
...
### Estradiol: low, med, high (<50, 50-75, 75+)
...
### Estradiol: low, med, high (33/33/33)


```{r}
#Read in data
hm_e33low <- read_csv(here("data", "heatmaps", "PointingDSP_E33Low.csv"))
hm_e33med <- read_csv(here("data", "heatmaps", "PointingDSP_E33Med.csv"))
hm_e33high <- read_csv(here("data", "heatmaps", "PointingDSP_E33High.csv"))


#ELow heatmap
a <- ggplot(hm_e33low, aes(x=x, y=z) ) +
  stat_density_2d(aes(fill = ..density..), geom = "raster", contour = FALSE) +
  #scale_fill_distiller(palette= "RdYlGn", direction=-1) +
  scale_fill_distiller(palette= "RdYlGn", direction=-1) +
  scale_x_continuous(expand = c(0, 0)) +
...
#Emed
b <- ggplot(hm_e33med, aes(x=x, y=z) ) +
  stat_density_2d(aes(fill = ..density..), geom = "raster", contour = FALSE) +
  #scale_fill_distiller(palette= "RdYlGn", direction=-1) +
  scale_fill_distiller(palette= "RdYlGn", direction=-1) +
  scale_x_continuous(expand = c(0, 0)) +
...
#Ehigh
c <- ggplot(hm_e33high, aes(x=x, y=z) ) +
  stat_density_2d(aes(fill = ..density..), geom = "raster", contour = FALSE) +
  #scale_fill_distiller(palette= "RdYlGn", direction=-1) +
  scale_fill_distiller(palette= "RdYlGn", direction=-1) +
  scale_x_continuous(expand = c(0, 0)) +
