...
```{r}
fit.totaleffect <- lm(dsp_si_true_pct ~ estradiol_scan_pg_ml, data=data_t1_women)
...
```{r}
fit.mediator <- lm(avg_t1_hipp ~ estradiol_scan_pg_ml, data=data_t1_women)
tidy(fit.mediator)
```
...
```{r}
fit.dv <- lm(dsp_si_true_pct ~ estradiol_scan_pg_ml + avg_t1_hipp, data=data_t1_women)
tidy(fit.dv)
```
...
```{r}
fit.totaleffect <- lm(dsp_si_true_pct ~ progesterone_scan_ng_ml, data=data_t1_women)
tidy(fit.totaleffect)

fit.mediator <- lm(avg_t1_hipp ~ progesterone_scan_ng_ml, data=data_t1_women)
tidy(fit.mediator)

fit.dv <- lm(dsp_si_true_pct ~ progesterone_scan_ng_ml + avg_t1_hipp, data=data_t1_women)
tidy(fit.dv)
```
...
```{r}
fit.totaleffect <- lm(dsp_si_true_pct ~ fsh_scan_miu_ml, data=data_t1_women)
tidy(fit.totaleffect)

fit.mediator <- lm(avg_t1_hipp ~ fsh_scan_miu_ml, data=data_t1_women)
tidy(fit.mediator)

fit.dv <- lm(dsp_si_true_pct ~ fsh_scan_miu_ml + avg_t1_hipp, data=data_t1_women)
tidy(fit.dv)
```
...
model <- ' # direct effect
           ...
           # mediator
             avg_t1_hipp ~ a*estradiol_scan_pg_ml
