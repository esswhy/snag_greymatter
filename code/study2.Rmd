...
Prior exploratory analysis for relationships between sex hormones and T2 subfield volume reveal certain significant relationships (`correlation_t2_hormones.Rmd`). Highlights of the results include estradiol negatively associated with ..... For progesterone, .... FSH was ...... For other brain structures, total T2 hippocampal volume was .... and MTL was ..... 
...
Following the correlations between hormones and brain structure, I explored the associations between brain structure and spatial navigation behaviors (`correlation_t2_hormones.Rmd` and `correlation_t1_hormones.Rmd`). Results revealed that for T2 hippocampal volume, 

For T1 hippocampal volume, women overall and pre-menopausal women with higher grey matter volume correlated with fewer degrees traveled in LOOP. Also within LOOP, larger grey mater was positively correlated with position error for pre-menopausal women (all Pearson). Overall, greater volume was associated with lower wayfinding success in DSP (Pearson). Higher DSP solution index was marginally positively associated with pre-manopausal women who had higher grey matter volume (Pearson).
