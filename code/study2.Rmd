...
```{r}
fit.totaleffect <- lm(dsp_si_true_pct ~ estradiol_spatial_pg_ml, data=data_t2_repo)
tidy(fit.totaleffect)

fit.mediator <- lm(avg_total_hipp ~ estradiol_spatial_pg_ml, data=data_t2_repo)
tidy(fit.mediator)

fit.dv <- lm(dsp_si_true_pct ~ estradiol_spatial_pg_ml + avg_total_hipp, data=data_t2_repo)
tidy(fit.dv)
```
...
```{r}
fit.totaleffect <- lm(dsp_si_true_pct ~ fsh_spatial_miu_ml, data=data_t2_repo)
tidy(fit.totaleffect)

fit.mediator <- lm(avg_total_hipp ~ fsh_spatial_miu_ml, data=data_t2_repo)
tidy(fit.mediator)

fit.dv <- lm(dsp_si_true_pct ~ fsh_spatial_miu_ml + avg_total_hipp, data=data_t2_repo)
tidy(fit.dv)
```
...
model <- ' # direct effect
             dsp_si_true_pct ~ c*fsh_spatial_miu_ml
           # mediator
             avg_total_hipp ~ a*fsh_spatial_miu_ml
             dsp_si_true_pct ~ b*avg_total_hipp
           # indirect effect (a*b)
             ab := a*b
           # total effect
...
fit.mediator <- lm(avg_ca1 ~ estradiol_spatial_pg_ml, data=data_t2_repo)
tidy(fit.mediator)

fit.dv <- lm(dsp_si_true_pct ~ estradiol_spatial_pg_ml + avg_ca1, data=data_t2_repo)
tidy(fit.dv)
```
...
model <- ' # direct effect
             dsp_si_true_pct ~ c*estradiol_spatial_pg_ml
           # mediator
             avg_ca1 ~ a*estradiol_spatial_pg_ml
...
fit.mediator <- lm(avg_ca23 ~ estradiol_spatial_pg_ml, data=data_t2_repo)
tidy(fit.mediator)

fit.dv <- lm(dsp_si_true_pct ~ estradiol_spatial_pg_ml + avg_ca23, data=data_t2_repo)
tidy(fit.dv)
```
...
model <- ' # direct effect
             dsp_si_true_pct ~ c*estradiol_spatial_pg_ml
           # mediator
             avg_ca23 ~ a*estradiol_spatial_pg_ml
             dsp_si_true_pct ~ b*avg_ca23
           # indirect effect (a*b)
             ab := a*b
           # total effect
             total := c + (a*b)
...
fit.mediator <- lm(avg_dg ~ estradiol_spatial_pg_ml, data=data_t2_repo)
tidy(fit.mediator)

fit.dv <- lm(dsp_si_true_pct ~ estradiol_spatial_pg_ml + avg_dg, data=data_t2_repo)
tidy(fit.dv)
```
...
model <- ' # direct effect
             dsp_si_true_pct ~ c*estradiol_spatial_pg_ml
           # mediator
             avg_dg ~ a*estradiol_spatial_pg_ml
             dsp_si_true_pct ~ b*avg_dg
           # indirect effect (a*b)
             ab := a*b
           # total effect
             total := c + (a*b)
...
fit.mediator <- lm(avg_erc ~ estradiol_spatial_pg_ml, data=data_t2_repo)
tidy(fit.mediator)

fit.dv <- lm(dsp_si_true_pct ~ estradiol_spatial_pg_ml + avg_erc, data=data_t2_repo)
tidy(fit.dv)
```
...
model <- ' # direct effect
             dsp_si_true_pct ~ c*estradiol_spatial_pg_ml
           # mediator
             avg_erc ~ a*estradiol_spatial_pg_ml
             dsp_si_true_pct ~ b*avg_erc
           # indirect effect (a*b)
             ab := a*b
           # total effect
             total := c + (a*b)
...
fit.mediator <- lm(avg_phc ~ estradiol_spatial_pg_ml, data=data_t2_repo)
tidy(fit.mediator)

fit.dv <- lm(dsp_si_true_pct ~ estradiol_spatial_pg_ml + avg_phc, data=data_t2_repo)
tidy(fit.dv)
```
...
model <- ' # direct effect
             dsp_si_true_pct ~ c*estradiol_spatial_pg_ml
           # mediator
             avg_phc ~ a*estradiol_spatial_pg_ml
             dsp_si_true_pct ~ b*avg_phc
           # indirect effect (a*b)
             ab := a*b
           # total effect
             total := c + (a*b)
...
fit.mediator <- lm(avg_prc ~ estradiol_spatial_pg_ml, data=data_t2_repo)
tidy(fit.mediator)

fit.dv <- lm(dsp_si_true_pct ~ estradiol_spatial_pg_ml + avg_prc, data=data_t2_repo)
tidy(fit.dv)
```
...
model <- ' # direct effect
             dsp_si_true_pct ~ c*estradiol_spatial_pg_ml
           # mediator
             avg_prc ~ a*estradiol_spatial_pg_ml
             dsp_si_true_pct ~ b*avg_prc
           # indirect effect (a*b)
             ab := a*b
           # total effect
             total := c + (a*b)
...
fit.mediator <- lm(avg_sub ~ estradiol_spatial_pg_ml, data=data_t2_repo)
tidy(fit.mediator)

fit.dv <- lm(dsp_si_true_pct ~ estradiol_spatial_pg_ml + avg_sub, data=data_t2_repo)
tidy(fit.dv)
```
...
model <- ' # direct effect
             dsp_si_true_pct ~ c*estradiol_spatial_pg_ml
           # mediator
             avg_sub ~ a*estradiol_spatial_pg_ml
             dsp_si_true_pct ~ b*avg_sub
           # indirect effect (a*b)
             ab := a*b
           # total effect
             total := c + (a*b)
