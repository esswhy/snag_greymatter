...
model <- ' # direct effect
             dsp_si_true_pct ~ c*progesterone_spatial_ng_ml
           # mediator
             avg_total_hipp ~ a*progesterone_spatial_ng_ml
             dsp_si_true_pct ~ b*avg_total_hipp
           # indirect effect (a*b)
             ab := a*b
           # total effect
...
model <- ' # direct effect
             dsp_si_true_pct ~ c*progesterone_spatial_ng_ml
           # mediator
             avg_ca1 ~ a*progesterone_spatial_ng_ml
             dsp_si_true_pct ~ b*avg_ca1
           # indirect effect (a*b)
             ab := a*b
           # total effect
...
model <- ' # direct effect
             dsp_si_true_pct ~ c*progesterone_spatial_ng_ml
           # mediator
             avg_ca23 ~ a*progesterone_spatial_ng_ml
             dsp_si_true_pct ~ b*avg_ca23
           # indirect effect (a*b)
             ab := a*b
           # total effect
...
model <- ' # direct effect
             dsp_si_true_pct ~ c*progesterone_spatial_ng_ml
           # mediator
             avg_dg ~ a*progesterone_spatial_ng_ml
             dsp_si_true_pct ~ b*avg_dg
           # indirect effect (a*b)
             ab := a*b
           # total effect
...
model <- ' # direct effect
             dsp_si_true_pct ~ c*progesterone_spatial_ng_ml
           # mediator
             avg_erc ~ a*progesterone_spatial_ng_ml
             dsp_si_true_pct ~ b*avg_erc
           # indirect effect (a*b)
             ab := a*b
           # total effect
...
model <- ' # direct effect
             dsp_si_true_pct ~ c*progesterone_spatial_ng_ml
           # mediator
             avg_phc ~ a*progesterone_spatial_ng_ml
             dsp_si_true_pct ~ b*avg_phc
           # indirect effect (a*b)
             ab := a*b
           # total effect
...
model <- ' # direct effect
             dsp_si_true_pct ~ c*progesterone_spatial_ng_ml
           # mediator
             avg_prc ~ a*progesterone_spatial_ng_ml
             dsp_si_true_pct ~ b*avg_prc
           # indirect effect (a*b)
             ab := a*b
           # total effect
...
model <- ' # direct effect
             dsp_si_true_pct ~ c*progesterone_spatial_ng_ml
           # mediator
             avg_sub ~ a*progesterone_spatial_ng_ml
             dsp_si_true_pct ~ b*avg_sub
           # indirect effect (a*b)
             ab := a*b
           # total effect
